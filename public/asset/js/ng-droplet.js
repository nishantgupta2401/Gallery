    ...
    function DropletDirective($rootScope, $window, $timeout, $q) {
        ...
        return {
            ...
            controller: ['$scope', function DropletController($scope) {
                 ...
                 * @return {$q.promise}
                 */
                $scope.uploadFiles = function uploadFiles(type,sub_cat_type,catId,templateId,subTemplateId) {
                    ...
                    if(type == 1){
                        if(subTemplateId){
                            ...
                            // `formData` object.
                            formData.append("subTemplateId", subTemplateId);
                            ...
                            $rootScope.$broadcast('$dropletError', "subTemplateId");
                        }
                    } else if(type == 3){
                        if(subTemplateId){
                            if(sub_cat_type == 1){
                                if(catId){
                                    ...
                                    $rootScope.$broadcast('$dropletError', "catId");
                                }
                            }else{
                                // Iterate all of the valid files to append them to the previously created
                                // `formData` object.
                        ...
                        if(templateId){
                            ...
                            $rootScope.$broadcast('$dropletError', "templateId");
                        }
                    }
                    
                };

                $scope.uploadFiles1 = function uploadFiles1(category_name) {
                    // Reset...
                    $scope.isError = false;
                    ...
                    if(category_name == ""){
                        $rootScope.$broadcast('$dropletError', "error");
                    }else{
                        // Iterate all of the valid files to append them to the previously created
                        // `formData` object.
                ...
                (function setupDirectiveInterface() {
                    ...
                    $scope.interface = {
                        ...
                        uploadFiles1: $scope.uploadFiles1,
                        ...
                        setRequestUrl: function setRequestUrl(url) {
                            $scope.options.requestUrl = imagesUrl+url;
                        },
